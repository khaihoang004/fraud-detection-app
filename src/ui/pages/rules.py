...
sample_data = pd.DataFrame({
    "transaction_id": [str(uuid.uuid4()) for _ in range(5)],
    "user_id": ["user_01", "user_02", "user_03", "user_04", "user_05"],
    "amount": [500, 12000, 450, 25000, 100],
    "Class": [0, 1, 0, 1, 0]  # 1 là Fraud, 0 là Normal
})
...
def create_rule_page():
    page = Page()
    with page:
        text("## 🛡️ Fraud Detection Rule Engine", mode="md")
...
if __name__ == "__main__":
    app_gui = Gui(page=create_rule_page())
    app_gui.run(
